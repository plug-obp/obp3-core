package z2mc.buchi.ndfs.gs09.cdlp05;

import obp3.buchi.ndfs.EmptinessCheckerAnswer;
import obp3.buchi.ndfs.gs09.cdlp05.EmptinessCheckerBuchiGS09CDLP05;
...
public class TestEmptinessCheckerBuchiGS09CDLP05 {
    EmptinessCheckerAnswer<Integer> ndfs(IRootedGraph<Integer> graph, Predicate<Integer> predicate) {
        return new EmptinessCheckerBuchiGS09CDLP05<>(graph, predicate).runAlone();
    }
