package z2mc.buchi.ndfs.gs09;

import obp3.buchi.ndfs.EmptinessCheckerAnswer;
import obp3.buchi.ndfs.cvwy92.EmptinessCheckerBuchiCVWY92Algo2;
import obp3.buchi.ndfs.gs09.EmptinessCheckerBuchiGS09;
...
public class TestEmptinessCheckerBuchiGS09 {
    EmptinessCheckerAnswer<Integer> ndfs(IRootedGraph<Integer> graph, Predicate<Integer> predicate) {
        return new EmptinessCheckerBuchiGS09<>(graph, predicate).runAlone();
    }
