package z2mc.buchi.ndfs.gs09.separated;

import obp3.buchi.ndfs.EmptinessCheckerAnswer;
import obp3.buchi.ndfs.gs09.separated.EmptinessCheckerBuchiGS09Separated;
...
public class TestEmptinessCheckerBuchiGS09Separated {
    EmptinessCheckerAnswer<Integer> ndfs(IRootedGraph<Integer> graph, Predicate<Integer> predicate) {
        return new EmptinessCheckerBuchiGS09Separated<>(graph, predicate).runAlone();
    }
